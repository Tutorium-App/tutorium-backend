...
class PaymentDetailsServices {
    ...
    static async storePayTutorDetails(reference, recipientCode, pendingTutorialID, tutorialID, tutorID, tutorName, tutorEmail, studentID, tutorNumber, title, amount, category) {
        const payTutorDetail = new payTutorDetailsModel({reference, recipientCode, pendingTutorialID, tutorialID, tutorID, tutorName, tutorEmail, studentID, tutorNumber, title, amount, category});
